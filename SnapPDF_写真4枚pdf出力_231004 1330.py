...
# 231004 タイトルと画像をpdf出力する。ページ番号表示。
# 複数フォルダから画像選択
# -------------------------------------------------------------
...
def create_pdf():
    ...
    # 画像を表示
    max_width = 530  # リサイズ後の最大幅（px）
    max_height = 300  # リサイズ後の最大高さ（px）
    images_per_page = 2  # 1ページあたりの画像数を4に変更
    cells_per_row = 2    # 2列のセルを作成
    image_width = 265  # 画像の幅
    image_height = 300  # 画像の高さ
